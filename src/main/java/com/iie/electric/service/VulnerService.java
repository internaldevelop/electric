...
import com.iie.electric.dao.VulnerDao;
import com.iie.electric.entity.Vulner;
import com.iie.electric.util.Poc_Validate;
import com.iie.electric.util.StringUtil;
import org.json.JSONArray;
import org.json.JSONObject;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.iie.electric.entity.PageBean;
...
//                else if("固件".equals(s_vulner.getS_method())){
//                    sb.append(" where affect_product like '%"+s_vulner.getS_value() + "'");
//                }
...
//                    sb.append(" or vul_time like '%"+s_vulner.getS_value()+"%'");
                    sb.append(" or first_type like '%"+s_vulner.getS_value()+"%'");
                    sb.append(" or affect_brand like '%"+s_vulner.getS_value()+"%'");
