...
import com.iie.electric.entity.VulInfo;
import com.iie.electric.entityview.ReportDeviceInfo;
import com.iie.electric.entityview.ReportResultCount;
import com.iie.electric.entityview.ReportVulDetailInfo;
import com.iie.electric.entityview.ReportVulInfo;
import com.iie.electric.service.ReportService;
                ...
                for (int j = 0; j < reportVulInfos.size(); j++) {
                    ...
                    for (int k = 0; k < serviceRowspan; k++) {
                        ...
                        if(reportVulInfo.getVulInfos()!=null && reportVulInfo.getVulInfos().size()>0){
                            vulInfo = reportVulInfo.getVulInfos().get(k);
                        }
