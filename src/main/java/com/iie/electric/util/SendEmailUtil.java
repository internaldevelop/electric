...
//        }
        ...
        mailProps.setProperty("mail.transport.protocol", "smtp");// 指定发送邮件协议(不能用put，用setProperty)
//        mailProps.put("mail.transport.protocol", "smtp");// 指定发送邮件协议
...
//                        return new PasswordAuthentication("1403125476@qq.com","wchlcwijnhxwfieg");
                return new PasswordAuthentication(simpleMail.getUsername(), simpleMail.getPassword());
//                return new PasswordAuthentication("1024445364@qq.com", "xsbzpaovdzabbdjj");
            }
...
//        simpleMail.setUsername("1024445364@qq.com");
//        simpleMail.setPassword("xsbzpaovdzabbdjj");
        simpleMail.setUsername("329070475@qq.com");
        simpleMail.setPassword("urntdrcapfrvbijd");
        simpleMail.setProtocol("smtp");
        simpleMail.setHost("smtp" + "." + "329070475");
        simpleMail.setFrom("329070475@qq.com");
        simpleMail.setTo("1024445364@qq.com");
        simpleMail.setSubject("测试主题");
        simpleMail.setContent("测试内容");
        simpleMail.setTaskReportPath("D:\\850-1-2019.07.06.pdf");

        SendEmailUtil sendEmailUtil = new SendEmailUtil(simpleMail);
