...
<link rel="stylesheet"
	...
	type="text/css">
<link rel="stylesheet"
	href="<c:url value="/public/css/404-8cf4ce9584.css" />" type="text/css">
					...
					<div class="col-md-12">
						...
						<div class="page-bar" style="border-bottom:none;">
							<ul class="page-breadcrumb">
								<li><i class="fa fa-frown-o"></i> <a href="javascript:;">404</a>
								</li>
							</ul>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="not-found">
							...
							<div class="content">
								<p class="title">我们很遗憾的通知您, 您访问的页面不存在! </p>
								<span> <em class="time">5</em> 秒后跳转到 <a href="<%=request.getContextPath()%>/project/project_list">项目列表页</a></span>
							</div>
						</div>
					</div>
				</div>
...
<![endif]-->
		...
		<script>
			...
			setTimeout( function count() {
				$time.text( --time );
				if( time === 0 ) {
					location.href = '<%=request.getContextPath()%>/project/project_list';
				}
