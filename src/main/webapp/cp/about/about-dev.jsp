...
<link rel="stylesheet"
	href="<c:url value="/public/css-dev/common.css" />" type="text/css">
					...
					<div class="col-md-12">
						...
						<div class="page-bar" style="border-bottom:none;">
							<ul class="page-breadcrumb">
								<li><i class="fa fa-home"></i> <a href="javascript:;">关于</a>
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="loading" style="display: none;">
							<img src="public/img/running.gif" style="height:50px">
						</div>
...
<![endif]-->
		...
		<script src="<c:url value="/public/lib/jquery.validate.min.js" />"
			type="text/javascript"></script>
		<script src="<c:url value="/public/js-dev/common.js" />"
			type="text/javascript"></script>
		<script src="<c:url value="/public/js-dev/validate-config.js" />"
			type="text/javascript"></script>
		<script src="<c:url value="/public/js-dev/subscribe.js" />"
			type="text/javascript"></script>
		<script src="<c:url value="/public/js/about.min.js" />"
			type="text/javascript"></script>
