                    ...
                    <div class="col-md-12">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li><i class="fa fa-home"></i><a href="javascript:;">用户管理</a></li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="add-wrapper">
                            <a class="btn c-btn add" href="" data-toggle="modal">添加用户</a>
                        </div>
...
<![endif]-->
    ...
    <script src="<c:url value="/public/lib/jquery.validate.min.js" />"
        type="text/javascript"></script>
    <script src="<c:url value="/public/lib/security.js" />"
            type="text/javascript"></script>
    ...
    <script src="<c:url value="/public/js/subscribe-2fc74f0121.js" />"
        type="text/javascript"></script>
    <script src="<c:url value="/public/js/checker-8ebe44bc56.js" />"
        type="text/javascript"></script>
