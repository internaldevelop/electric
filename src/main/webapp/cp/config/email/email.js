...
var TableCell = React.createClass( {
    render: function() {
        ...
        return  <tr>
        			<td>{props.startIndex}</td>
              		<td className="port">{props.port}</td>
              		<td className="protocol">{props.protocol}</td>
               		<td className="type">{props.type}</td>
               		<td className="encode">{props.encode}</td>
               		<td className="fileName">{props.fileName}</td>
               		<td className="addTime">{props.addTime}</td>
               		<td className="operate">
               			<a className="update" href="javascript:;">修改</a>
