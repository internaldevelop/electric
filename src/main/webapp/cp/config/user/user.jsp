...
<link rel="stylesheet" href="<c:url value="/public/css/user-16ce9d3f68.css" />" type="text/css">
...
<script src="<c:url value="/public/lib/security.js" />" type="text/javascript"></script>
<script src="<c:url value="/public/js/validate-config-c05a002e2e.js" />" type="text/javascript"></script>
<script src="<c:url value="/public/js/user-d2f6d30aa8.js" />" type="text/javascript"></script>
