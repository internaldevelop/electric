...
<link rel="stylesheet"
	href="<c:url value="/public/css/common.css" />" type="text/css">
<link rel="stylesheet"
	href="<c:url value="/public/css/task_detail.css" />" type="text/css">
...
<![endif]-->
	...
	<script src="<c:url value="/public/js/subscribe.js" />"
		type="text/javascript"></script>
	<script src="<c:url value="/public/js/task_detail.js" />"
		type="text/javascript"></script>
</body>
<!-- END BODY -->
</html>