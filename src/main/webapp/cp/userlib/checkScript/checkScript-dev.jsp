...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<a class="btn red btn-outline sbold" href="#addModel" data-toggle="modal">添加</a>
					<div id="table"></div>
					...
					<div class="modal fade in" id="addModel" tabindex="-1" role="basic" aria-hidden="true" style="padding-left: 17px;">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								 <!--表单开始-->
								 <div class="form">
									<form id="add" action="aa" class="form-horizontal" role="form" enctype="multipart/form-data" method="POST">
										<div class="form-body">
											<div class="exist">
												上传成功!
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">验证脚本
													<span class="required" aria-required="true">* </span>
												</label>
												<div class="col-md-8">
													<input name="checkScript" type="file" class="form-control">
