					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								 <!--表单开始-->
								 <div class="form">
									<form id="add" action="aa" class="form-horizontal" role="form" method="GET">
										<div class="form-body">
											<div class="exist">
												已经添加过该用户名和密码组合!
											</div>
											...
											<div class="form-group">
												<label class="col-md-3 control-label">密&nbsp;&nbsp;&nbsp;&nbsp;码
													<span class="required" aria-required="true">* </span>
												</label>
												<div class="col-md-8">
										...
										<div class="modal-footer">
											<button type="button" class="btn blue submit">添加</button>
