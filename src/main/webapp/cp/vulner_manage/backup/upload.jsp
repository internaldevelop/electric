...
<head>
	...
	<script type="text/javascript">
        ...
        function submitFrom(){
            if (checkinput()){
                if(confirm("确定上传本地备份文件吗?")){
                    var form = new FormData(document.getElementById("backup"));
                    $.ajax({
                        url:"${pageContext.request.contextPath}/vulner_manage/backup/file_upload",
                        type:"post",
                        data:form,
                        processData:false,
                        contentType:false,
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="page-bar" style="border-bottom:none;">
                            <ul class="page-breadcrumb">
								...
								<li> > </li>
                                <li><a href="javascript:;">上传备份</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" id="backup">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" maxlength="500" id="remark" name="remark" value="${backup.remark }" maxlength="15" style="width: 300px" required="required" placeholder="十五个字符以内，请勿包含特殊字符...">
                                </div>
                            </div>
                            <div class="form-group">
                                <label  class="col-sm-2 control-label">选择文件：</label>
                                <div class="col-sm-10">
                                    <input type="file" class="form-control" id="Filename" name="Filename" style="width: 300px" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="button" class="btn btn-primary" onclick="submitFrom()">上传</button>&nbsp;&nbsp;
