  ...
  return {
    ...
    link: function(scope, element, attrs) {
      $(function() {
        ...
        // create a shallow copy of module's current state, needed to determine
        // diff when module changes
        ...
        scope.$watch("model", function() {
          ...
          // Remove tags no longer in binded module
          ...
          // Add new items in module as tags
