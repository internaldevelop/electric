 ...
 */
	...
	$.jstree.core.prototype = {
		 ...
		 * @trigger module.jstree, changed.jstree
		 */
		...
		/**
		 * parses a node from a jQuery object and appends them to the in memory tree module. Used internally.
		 * @private
		 * @name _parse_model_from_html(d [, p, ps])
		 * @param  {jQuery} d the jQuery object to parse
		 * @param  {String} p the parent ID
		 * @param  {Array} ps list of all parents
		 * @return {String} the ID of the object added to the module
		 */
		...
		/**
		 * parses a node from a JSON object (used when dealing with flat data, which has no nesting of children, but has id and parent properties) and appends it to the in memory tree module. Used internally.
		 * @private
		...
		/**
		 * parses a node from a JSON object and appends it to the in memory tree module. Used internally.
		 * @private
		...
		set_id : function (obj, id) {
			...
			// update module and obj itself (obj.id, this._model.data[KEY])
		 ...
		 * @trigger module.jstree, create_node.jstree
		 */
		 ...
		 * @param  {Boolean} skip_redraw internal parameter indicating if the tree should be redrawn
		 * @param  {Boolean} instance internal parameter indicating if the node comes from another instance
		 * @trigger module.jstree copy_node.jstree
		 */
